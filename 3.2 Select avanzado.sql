...
SELECT *
FROM ventas
WHERE cliente_id = 1 OR empleado_id >= 3;
...
SELECT *
FROM ventas
WHERE empleado_id = 2 AND monto_total > 2000;

-- ✏️ Ejercicios: Cláusula BETWEEN
