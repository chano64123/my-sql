...
SELECT salario, (salario*1.1) AS 'Aumento del 10%'
FROM empleados;

-- Crea una consulta que calcule el monto total de las compras realizadas por 
-- cliente y que la columna se llame “Monto total gastado”.
...
-- Crea una consulta que muestre el nombre de los empleados y los categorice como "Joven" si tienen 
-- menos de 30 años, "Adulto" si tienen entre 30 y 40 años, y "Mayor" si tienen más de 40 años.
SELECT 
	nombre AS empleado,
	CASE
...
-- Crea una consulta que muestre el ID de la venta y los categorice como "Poca cantidad" si la cantidad 
-- es menor que 3, "Cantidad moderada" si es igual o mayor que 3 y menor que 6, y "Mucha cantidad" en otros casos.
SELECT
	id,
	CASE
...
-- Crea una consulta que muestre el nombre de los clientes y los categorice como "Comienza con A" si 
-- su nombre comienza con la letra 'A', "Comienza con M" si comienza con 'M' y "Otros" en otros casos.
SELECT 
	nombre AS cliente,
	CASE
...
-- Crea una consulta que muestre el nombre de los empleados y los categorice como "Salario alto" si 
-- el salario es mayor o igual a $3500, "Salario medio" si es mayor o igual a $3000 y menor que $3500, y 
